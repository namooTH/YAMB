...
class textbox(commands.Cog):
    ...
    async def textbox(self, interaction: discord.Interaction, portrait: discord.Attachment, name: Optional[str], text: str, animated: Optional[app_commands.Choice[str]]):

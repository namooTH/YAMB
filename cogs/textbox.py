...
class textbox(commands.Cog):
    ...
    @app_commands.choices(choices=[app_commands.Choice(name="Yes", value="true"),app_commands.Choice(name="No", value="false")])
    async def textbox(self, interaction: discord.Interaction, portrait: discord.Attachment, name: Optional[str], text: str, animated: Optional[app_commands.choices[str]]):
